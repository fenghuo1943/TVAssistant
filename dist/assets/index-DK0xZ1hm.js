...
`,bs={id:`yangshipin`,name:`央视频直播`,matches:[`https://www.yangshipin.cn/tv/home`],capabilities:{liveMenu:!0,volumeControl:!0},defaultConfig:{volume:.6}};function xs(e){return`
${ys}
${e}
  `}var Ss=[{manifest:bs,matches:e=>bs.matches.some(t=>e.startsWith(t)),buildInitScript:e=>xs(`window.__tvAssistantPlugins.yangshipin.init(${JSON.stringify(e)});`),buildMenuDataScript:()=>xs(`window.__tvAssistantPlugins.yangshipin.waitForMenuData(20000);`),buildSelectChannelScript:e=>xs(`window.__tvAssistantPlugins.yangshipin.selectChannel(${JSON.stringify(e)});`),buildAdjustVolumeScript:e=>xs(`window.__tvAssistantPlugins.yangshipin.adjustVolume(${e});`)}];function Cs(e){return Ss.find(t=>t.matches(e))??null}function ws(e,t={}){let{level:n=`error`}=t;if(console.error(`[${n}] ${e}`),typeof window<`u`){let t=document.createElement(`div`);t.className=`error-toast`,t.textContent=e;let r={info:`rgba(0, 122, 255, 0.9)`,warning:`rgba(255, 149, 0, 0.9)`,error:`rgba(255, 59, 48, 0.9)`};t.style.cssText=`
      position: fixed;
      top: 20px;
      right: 20px;
      padding: 12px 24px;
      ...
      font-size: 14px;
      max-width: 400px;
    `,document.body.appendChild(t),setTimeout(()=>{t.style.animation=`slideOut 0.3s ease`,setTimeout(()=>t.remove(),300)},3e3)}}async function Ts(e,t={}){let{maxRetries:n=3,retryable:r=!0,message:i}=t,a;for(let t=0;t<n;t++)try{return await e()}catch(e){if(a=e,!r||t===n-1)break;let i=1e3*(t+1);console.warn(`重试中... (${t+1}/${n})，${i}ms 后重试`),await new Promise(e=>setTimeout(e,i))}throw i&&ws(i,{...t,level:`error`}),a}var Es={GENERAL:`general`,SITE_MANAGEMENT:`site-management`,ADD_SITE:`add-site`,ADD_LOCAL_APP:`add-local-app`,WALLPAPER:`wallpaper`},Ds=[{name:`TV 直播`,badge:`LIVE`,url:`https://www.yangshipin.cn/tv/home`,theme:`theme-live`},{name:`央视片库`,badge:`CCTV`,url:`https://tv.cctv.com/`,theme:`theme-cctv`},{name:`抖音`,badge:`DY`,url:`https://www.douyin.com/`,theme:`theme-douyin`},{name:`腾讯视频`,badge:`QQ`,url:`https://v.qq.com/`,theme:`theme-tencent`}];function Os(){let e=V([]);return{refs:e,setRef:(t,n)=>{t?e.value[n]=t:delete e.value[n]},focus:t=>{let n=e.value[t];n instanceof HTMLElement&&(n.focus(),n.scrollIntoView({behavior:`smooth`,block:`nearest`}))},blur:t=>{let n=e.value[t];n instanceof HTMLElement&&n.blur()},getRef:t=>e.value[t]??null,getTotal:()=>e.value.length}}function ks(e=null){let t=V(e);return{ref:t,setRef:e=>{e instanceof Element?t.value=e:t.value=null},focus:()=>{t.value instanceof HTMLElement&&(t.value.focus(),t.value.scrollIntoView({behavior:`smooth`,block:`nearest`}))},blur:()=>{t.value instanceof HTMLElement&&t.value.blur()},exists:()=>t.value!==null}}function As(){let e=At({visible:!1,groupIndex:0,column:`group`,groups:[{label:`央视频道`,items:[`内容稍后添加`]},{label:`卫视频道`,items:[`内容稍后添加`]}],itemIndices:[0,0]}),t=V(``),n=V(``),r=V({}),i=$(()=>e.groups[e.groupIndex]),a=$(()=>e.itemIndices[e.groupIndex]??0),o=$(()=>i.value?.items??[]),s=$(()=>t.value||i.value?.label||``);function c(){e.visible=!e.visible,e.visible||(e.column=`group`)}function l(){e.visible=!1,e.column=`group`}function u(t){let n=e.groups.length;e.groupIndex=(e.groupIndex+t+n)%n}function d(t){let n=o.value.length,r=(a.value+t+n)%n;e.itemIndices[e.groupIndex]=r}function f(n){if(!n)return;let r=n.trim();t.value=r;let i=e.groups.findIndex(e=>e.items.includes(r));if(i===-1)return;let a=e.groups[i].items.indexOf(r);e.groupIndex=i,e.itemIndices[i]=a}function p(t){let n=t.央视频道?.length?t.央视频道:[`内容稍后添加`],r=t.卫视频道?.length?t.卫视频道:[`内容稍后添加`];e.groups=[{label:`央视频道`,items:n},{label:`卫视频道`,items:r}],e.itemIndices=e.groups.map(()=>0),e.groupIndex=0,f(t.currentChannel??``)}function m(){e.column=e.column===`group`?`item`:`group`}return{state:e,currentChannel:t,currentPluginId:n,currentPluginConfig:r,currentGroup:i,currentItemIndex:a,currentItems:o,heading:s,toggle:c,close:l,moveGroup:u,moveItem:d,syncChannel:f,applyGroups:p,switchColumn:m}}lo(wo(Pn({__name:`HomePage`,setup(e){let t=window.require?.(`electron`)?.ipcRenderer??null,n=As(),r=Os(),i=ks(),a=ks(),o=At({now:new Date,selectedIndex:0,activeUrl:``,activeTitle:``,showSettings:!1,activeSettingsMenu:Es.GENERAL,settings:{...Wo}}),s=At({currentPluginId:``,currentPluginConfig:{}}),c,l=0,u=new Intl.DateTimeFormat(`zh-CN`,{month:`long`,day:`numeric`,weekday:`long`}),d=$(()=>Ds.filter(e=>o.settings.enabledShortcuts.includes(e.url))),f=$(()=>o.now.toLocaleTimeString(`zh-CN`,{hour:`2-digit`,minute:`2-digit`,hour12:!1})),p=$(()=>Cs(o.activeUrl)),m=$(()=>u.format(o.now)),h=$(()=>p.value?.manifest.capabilities.liveMenu??!1);function g(){o.now=new Date}function _(){o.showSettings=!0}function v(){o.showSettings=!1,U(()=>{T()})}function y(e){o.activeUrl=e.url,o.activeTitle=e.name,o.showSettings=!1,n.close(),n.currentChannel.value=``,s.currentPluginId=``,s.currentPluginConfig={},U(()=>{i.ref.value?.focus()})}function b(){if(!o.settings.openModuleOnLaunch||!o.settings.launchModuleId)return;let e=Ds.find(e=>e.url===o.settings.launchModuleId);e&&y(e)}function x(){o.activeUrl=``,o.activeTitle=``,n.close(),n.currentChannel.value=``,s.currentPluginId=``,s.currentPluginConfig={},U(()=>{T()})}function S(e,t){r.setRef(e,t)}function C(e){i.setRef(e)}function w(e){a.setRef(e)}function T(){r.getRef(o.selectedIndex)?.focus()}function ee(e){let t=d.value.length;t!==0&&(o.selectedIndex=(o.selectedIndex+e+t)%t,T())}function E(){h.value&&n.toggle()}function D(){n.close()}function te(e){let t=n.state.groupIndex;n.moveGroup(e),t!==n.state.groupIndex&&U(()=>{setTimeout(()=>{let e=document.querySelector(`.live-menu-channel-item.is-active`)||document.querySelector(`.live-menu-channel-item.is-selected`);e&&e.scrollIntoView({behavior:`smooth`,block:`nearest`})},80)})}function O(e){n.moveItem(e),U(()=>{setTimeout(()=>{let e=document.querySelector(`.live-menu-channel-item.is-active`)||document.querySelector(`.live-menu-channel-item.is-selected`);e&&e.scrollIntoView({behavior:`smooth`,block:`nearest`})},50)})}function ne(e){n.syncChannel(e)}function re(e){n.applyGroups(e)}async function k(e){try{return await Ts(async()=>await t?.invoke(`plugin-config:get`,e)??{},{message:`加载插件 ${e} 配置失败`,retryable:!0,maxRetries:3})}catch{return ws(`无法加载插件配置，请检查网络连接`),{}}}async function ie(e,n){try{s.currentPluginConfig=n,await Ts(async()=>{await t?.invoke(`plugin-config:set`,e,n)},{message:`保存插件 ${e} 配置失败`,retryable:!0,maxRetries:3})}catch(e){throw ws(`保存插件配置失败，请稍后重试`),e}}async function A(){try{let e=await Ts(async()=>await t?.invoke(`settings:get`),{message:`加载设置失败`,retryable:!0,maxRetries:3});o.settings={...Wo,...e}}catch{ws(`无法加载设置，将使用默认配置`),o.settings={...Wo}}}async function ae(e){try{await Ts(async()=>await t?.invoke(`settings:set`,e),{message:`保存设置失败`,retryable:!0,maxRetries:3}),o.settings={...o.settings,...e},ws(`设置已保存`,{level:`info`})}catch(e){throw ws(`保存设置失败，请稍后重试`),e}}async function oe(){let e=a.ref.value,t=p.value;if(!e||!t)return null;s.currentPluginId!==t.manifest.id&&(s.currentPluginConfig={...t.manifest.defaultConfig,...await k(t.manifest.id)},s.currentPluginId=t.manifest.id);try{await e.executeJavaScript(t.buildInitScript(s.currentPluginConfig),!0)}catch(e){return console.error(`初始化插件 ${t.manifest.id} 失败:`,e),null}return t}async function se(){let e=a.ref.value,t=p.value;if(!e||!t?.manifest.capabilities.liveMenu)return;let n=++l;try{await oe();let r=await e.executeJavaScript(t.buildMenuDataScript(),!0);if(n!==l||!r)return;re(r)}catch(e){console.error(`获取插件 ${t.manifest.id} 菜单数据失败:`,e),re({})}}async function ce(e){let t=a.ref.value,n=p.value;if(!(!t||!n?.manifest.capabilities.liveMenu))try{ne(e),await oe(),await t.executeJavaScript(n.buildSelectChannelScript(e),!0)&&(D(),window.setTimeout(()=>{se()},1200))}catch(e){console.error(`插件 ${n.manifest.id} 切换频道失败:`,e)}}async function le(e){let t=a.ref.value,n=p.value;if(!(!t||!n?.manifest.capabilities.volumeControl))try{await oe();let r=await t.executeJavaScript(n.buildAdjustVolumeScript(e),!0);typeof r==`number`&&await ie(n.manifest.id,{...s.currentPluginConfig,volume:r})}catch(e){console.error(`插件 ${n.manifest.id} 调整音量失败:`,e)}}function ue(){let e=p.value;e&&(oe(),e.manifest.capabilities.liveMenu&&se())}function de(e){o.showSettings&&o.activeUrl}function fe(e){if(!(o.showSettings&&!o.activeUrl)){if(o.activeUrl){if(n.state.visible){if(e.key===`Escape`||e.key===`Backspace`){e.preventDefault(),D();return}if(e.key===`ArrowLeft`||e.key===`ArrowRight`){e.preventDefault(),n.switchColumn();return}if(e.key===`ArrowUp`){if(e.preventDefault(),n.state.column===`group`){te(-1);return}O(-1);return}if(e.key===`ArrowDown`){if(e.preventDefault(),n.state.column===`group`){te(1);return}O(1);return}if(e.key===`Enter`&&n.state.column===`item`){e.preventDefault(),ce(n.currentItems.value[n.currentItemIndex.value]);return}return}if(h.value&&e.key===`Enter`){e.preventDefault(),E();return}if(e.key===`-`||e.key===`_`){e.preventDefault(),le(-.05);return}if(e.key===`=`||e.key===`+`){e.preventDefault(),le(.05);return}(e.key===`Escape`||e.key===`Backspace`)&&(e.preventDefault(),x());return}if(e.key===`ArrowLeft`||e.key===`ArrowUp`){e.preventDefault(),ee(-1);return}if(e.key===`ArrowRight`||e.key===`ArrowDown`){e.preventDefault(),ee(1);return}(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),d.value.length>0&&y(d.value[o.selectedIndex]))}}function pe(e,t){fe(new KeyboardEvent(`keydown`,{key:t.key}))}function me(){window.close()}return Yn(async()=>{g(),c=window.setInterval(g,1e3),t?.on(`app-keydown`,pe),await A(),b(),U(()=>{T()})}),Qn(()=>{c&&window.clearInterval(c),t?.removeListener(`app-keydown`,pe)}),(e,t)=>(Y(),X(`main`,{class:j([`home-shell`,{"is-browser-open":!!o.activeUrl}]),tabindex:`0`,onKeydown:fe,onKeydownCapture:de},[o.showSettings?(Y(),ki(vs,{key:0,"active-menu":o.activeSettingsMenu,settings:o.settings,onBack:v,onSelectMenu:t[0]||=e=>o.activeSettingsMenu=e,onUpdateSetting:ae},null,8,[`active-menu`,`settings`])):o.activeUrl?(Y(),ki(To,{key:2,"active-url":o.activeUrl,"set-back-button-ref":C,"set-webview-ref":w,"show-live-menu":Vt(n).state.visible,"live-menu-groups":Vt(n).state.groups,"active-live-group-index":Vt(n).state.groupIndex,"active-live-column":Vt(n).state.column,"active-live-item-index":Vt(n).currentItemIndex.value,"live-menu-heading":Vt(n).heading.value,onBrowserReady:ue,onGoHome:x,onSelectLiveChannel:ce},null,8,[`active-url`,`show-live-menu`,`live-menu-groups`,`active-live-group-index`,`active-live-column`,`active-live-item-index`,`live-menu-heading`])):(Y(),ki(Ro,{key:1,"current-time":f.value,"current-date":m.value,shortcuts:d.value,"selected-index":o.selectedIndex,"set-card-ref":S,onOpenSettings:_,onCloseWindow:me,onOpenSite:y,onFocusCard:t[1]||=e=>o.selectedIndex=e},null,8,[`current-time`,`current-date`,`shortcuts`,`selected-index`]))],34))}}),[[`__scopeId`,`data-v-bf9d3f86`]])).mount(`#app`);